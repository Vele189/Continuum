...
def migrate():
    ...
    try:
        ...
        if cur.fetchone():
            ...
            cur.execute("CREATE INDEX ix_milestones_project_id_status ON milestones (project_id, status);")
            print("Index created.")
        ...
        if "milestone_id" in columns:
            ...
            cur.execute("ALTER TABLE tasks ADD COLUMN milestone_id INTEGER REFERENCES milestones(id) ON DELETE SET NULL ON UPDATE CASCADE;")
