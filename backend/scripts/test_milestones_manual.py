...
app.dependency_overrides[deps.get_current_active_admin] = mock_get_current_user # Override admin dep too
...
def test_milestone_flow():
    ...
    if p_res.status_code in [404, 500, 422]: 
         print(f"   Project creation failed ({p_res.status_code}). Attempting to create Client first...")
    ...
    if task_res.status_code != 201:
        ...
        link_res = client.patch(f"/api/v1/tasks/{task_id}/milestone", json={
