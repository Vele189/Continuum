...
const ForgotPassword = () => {
  return (
    <div className="bg-linear-to-b from-[#B2E6F7] to-[#FFFFFF] min-h-screen flex items-center justify-center relative overflow-hidden ">
      <div className="bg-white w-86.25 h-75.75  flex flex-col justify-center items-center px-6 pt-2 pb-9 border-2 border-gray-100 rounded-2xl shadow-lg">
        <div className="bg-[#F9F9F9]  flex items-center gap-4 mb-6 w-full text-[22px] font-medium text-[#595959]">
          <Link to="/login">
        ...
        <form className="w-full max-w-sm">
          <div className="mb-4">
            ...
            <input
              type="email"
              id="email"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-500 text-[16px]"
